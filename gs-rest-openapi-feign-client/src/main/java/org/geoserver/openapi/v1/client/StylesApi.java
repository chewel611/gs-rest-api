...
import java.io.File;
import org.geoserver.openapi.v1.model.StyleInfoPostWrapper;
...
public interface StylesApi extends ApiClient.Api {
   ...
   * @param styleInfoPostWrapper Style body information naming an existing style to add to the layer (required)
   * @param _default Whether to make this the default style for the layer. (optional, default to false)
   */
  @RequestLine("POST /rest/layers/{layer}/styles?default={_default}")
  @Headers({
    "Content-Type: application/json",
    "Accept: application/json",
  })
  void addStyleToLayer(@Param("layer") String layer, StyleInfoPostWrapper styleInfoPostWrapper, @Param("_default") Boolean _default);

  /**
   * Add a new style
   * Adds a new style entry to the layer. The style named in styleBody must alread exist, and will not be altered by this request.
   * Note, this is equivalent to the other <code>addStyleToLayer</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link AddStyleToLayerQueryParams} class that allows for
   ...
   *   <ul>
   *   <li>_default - Whether to make this the default style for the layer. (optional, default to false)</li>
   *   </ul>
   */
  @RequestLine("POST /rest/layers/{layer}/styles?default={_default}")
  @Headers({
  ...
  void addStyleToLayer(@Param("layer") String layer, StyleInfoPostWrapper styleInfoPostWrapper, @QueryMap(encoded=true) Map<String, Object> queryParams);
   ...
   * @param name The name of the style. Used only when POSTing a style file or ZIP bundle, to determine the name of the style in the catalog. Generated from the filename if not provided. (optional)
   * @return String
   */
   ...
   * Add a new style
   * Adds a new style entry to the server. Using POST with the &#x60;application/xml&#x60; or &#x60;application/json&#x60; content only adds the style info to the catalog and does not upload style content. PUT to &#x60;/styles/{style}&#x60; to upload the style in this case. Use POST with a style file (&#x60;application/vnd.ogc.sld+xml&#x60; or &#x60;application/vnd.ogc.sld+xml&#x60; for SLD; additional style types are added by extensions) to generate a style info and upload the style all at once. Then seperately PUT the style info at &#x60;/styles/{style}&#x60; to make any desired changes to the generated catalog entry. You can also use POST with a ZIP file to upload a SLD 1.0 (&#x60;application/vnd.ogc.sld+xml&#x60;) file and any associated icon files, and then separately PUT the style info at /styles/{style}. POST with a ZIP file does not support any other style types. 
   * Note, this is equivalent to the other <code>createStyle</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link CreateStyleQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param styleInfoWrapper The StyleInfo body of a request. (required)
   * @param queryParams Map of query parameters as name-value pairs
   *   <p>The following elements may be specified in the query map:</p>
   *   <ul>
   *   <li>name - The name of the style. Used only when POSTing a style file or ZIP bundle, to determine the name of the style in the catalog. Generated from the filename if not provided. (optional)</li>
   *   </ul>
   * @return String
   */
  @RequestLine("POST /rest/styles?name={name}")
   ...
   * @return String
   */
  @RequestLine("POST /rest/workspaces/{workspace}/styles?name={name}")
  @Headers({
    "Content-Type: application/json",
    "Accept: text/plain",
  })
  String createStyleByWorkspace(@Param("workspace") String workspace, StyleInfoWrapper styleInfoWrapper, @Param("name") String name);

  /**
   * Add a new style to a given workspace
   * Adds a new style entry to the server. Using POST with the &#x60;application/xml&#x60; or &#x60;application/json&#x60; content only adds the style info to the catalog and does not upload style content. PUT to &#x60;/workspaces/{workspace}/styles/{style}&#x60; to upload the style in this case. Use POST with a style file (&#x60;application/vnd.ogc.sld+xml&#x60; or &#x60;application/vnd.ogc.sld+xml&#x60; for SLD; additional style types are added by extensions) to generate a style info and upload the style all at once. Then seperately PUT the style info at &#x60;/workspaces/{workspace}/styles/{style}&#x60; to make any desired changes to the generated catalog entry. You can also use POST with a ZIP file to upload a SLD 1.0 (&#x60;application/vnd.ogc.sld+xml&#x60;) file and any associated icon files, and then separately PUT the style info at /workspaces/{workspace}/styles/{style}. POST with a ZIP file does not support any other style types.
   * Note, this is equivalent to the other <code>createStyleByWorkspace</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link CreateStyleByWorkspaceQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param workspace Name of workspace (required)
   * @param styleInfoWrapper The StyleInfo body of a request. (required)
   * @param queryParams Map of query parameters as name-value pairs
  ...
  String createStyleByWorkspace(@Param("workspace") String workspace, StyleInfoWrapper styleInfoWrapper, @QueryMap(encoded=true) Map<String, Object> queryParams);
   ...
   * @param purge Specifies whether the underlying file containing the style should be deleted on disk. (optional, default to false)
   * @param recurse Removes references to the specified style in existing layers. (optional, default to false)
   */
  @RequestLine("DELETE /rest/styles/{style}?purge={purge}&recurse={recurse}")
  @Headers({
    "Accept: application/json",
  })
   ...
   * Delete style
   * Deletes a style.
   * Note, this is equivalent to the other <code>deleteStyle</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link DeleteStyleQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param style Name of the style to retrieve. (required)
   * @param queryParams Map of query parameters as name-value pairs
   *   <p>The following elements may be specified in the query map:</p>
   *   <ul>
   *   <li>purge - Specifies whether the underlying file containing the style should be deleted on disk. (optional, default to false)</li>
   *   <li>recurse - Removes references to the specified style in existing layers. (optional, default to false)</li>
   *   </ul>
   */
  @RequestLine("DELETE /rest/styles/{style}?purge={purge}&recurse={recurse}")
  @Headers({
   ...
   * @param recurse Removes references to the specified style in existing layers. (optional, default to false)
   */
  @RequestLine("DELETE /rest/workspaces/{workspace}/styles/{style}?purge={purge}&recurse={recurse}")
  @Headers({
    "Accept: application/json",
  })
  void deleteStyleByWorkspace(@Param("workspace") String workspace, @Param("style") String style, @Param("purge") Boolean purge, @Param("recurse") Boolean recurse);

  /**
   * Delete style in a given workspace
   * Deletes a style in a given workspace.
   * Note, this is equivalent to the other <code>deleteStyleByWorkspace</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link DeleteStyleByWorkspaceQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param workspace Name of the workspace for style definitions (required)
   * @param style Name of the style to retrieve. (required)
   * @param queryParams Map of query parameters as name-value pairs
  ...
  void deleteStyleByWorkspace(@Param("workspace") String workspace, @Param("style") String style, @QueryMap(encoded=true) Map<String, Object> queryParams);
   ...
   */
  @RequestLine("GET /rest/styles/{style}")
  @Headers({
    "Accept: application/json",
  })
   ...
   * @return StyleInfoWrapper
   */
  @RequestLine("GET /rest/workspaces/{workspace}/styles/{style}?quietOnNotFound={quietOnNotFound}")
  @Headers({
    "Accept: application/json",
  })
  StyleInfoWrapper getStyleByWorkspace(@Param("workspace") String workspace, @Param("style") String style, @Param("quietOnNotFound") Boolean quietOnNotFound);

  /**
   * Retrieve a style from a given workspace
   * Retrieves a single style. Used to both request the style info and the style defintion body, depending on the media type requested. The media type can be specified either by using the \&quot;Accept:\&quot; header or by appending an extension to the endpoint. For example, a style info can be requested in XML format using \&quot;/styles/{style}.xml\&quot; or \&quot;Accept: application/xml\&quot;. (Also available: \&quot;{style}.json\&quot;, \&quot;Accept: application/json\&quot; \&quot;{style}.html\&quot;, and \&quot;Accept: text/html\&quot;). The style definition body can be requested by either appending the file extension of the style file (e.g., \&quot;{style}.sld\&quot; or \&quot;{style}.css\&quot;) or by specifying the correct media type for the style definition in the \&quot;Accept\&quot; header. Below are common style formats and the corresponding media types that can be used in the Accept header to request the style definition body. - application/vnd.ogc.sld+xml for SLD 1.0.0 SLDs - application/vnd.ogc.se+xml for SLD 1.1.0 SLDs - application/vnd.geoserver.geocss+css for css styles - application/vnd.geoserver.ysld+yaml for ysld styles - application/vnd.geoserver.mbstyle+json for mb styles 
   * Note, this is equivalent to the other <code>getStyleByWorkspace</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link GetStyleByWorkspaceQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param workspace Name of the workspace for style definitions (required)
   * @param style Name of the style to retrieve. (required)
   * @param queryParams Map of query parameters as name-value pairs
  ...
  StyleInfoWrapper getStyleByWorkspace(@Param("workspace") String workspace, @Param("style") String style, @QueryMap(encoded=true) Map<String, Object> queryParams);

  /**
   * A convenience class for generating query parameters for the
   * <code>getStyleByWorkspace</code> method in a fluent style.
   */
  public static class GetStyleByWorkspaceQueryParams extends HashMap<String, Object> {
    public GetStyleByWorkspaceQueryParams quietOnNotFound(final Boolean value) {
   ...
   * @return StyleList
   */
  @RequestLine("GET /rest/layers/{layer}/styles")
  @Headers({
    "Accept: application/json",
  })
   ...
   * @return StyleListWrapper
   */
  @RequestLine("GET /rest/workspaces/{workspace}/styles")
  @Headers({
    "Accept: application/json",
  })
   ...
   * @param raw When set to \&quot;true\&quot;, will forgo parsing and encoding of the uploaded style content, and instead the style will be streamed directly to the GeoServer configuration. Use this setting if the content and formatting of the style is to be preserved exactly. May result in an invalid and unusable style if the payload is malformed. Allowable values are \&quot;true\&quot; or \&quot;false\&quot; (default). Only used when uploading a style file. (optional, default to false)
   */
  @RequestLine("PUT /rest/styles/{style}?raw={raw}")
  @Headers({
    "Content-Type: application/vnd.geoserver.mbstyle+json",
    "Accept: application/json",
  })
  void uploadStyle(@Param("style") String style, File body, @Param("raw") Boolean raw);

  /**
   * Modify a single style
   * Modifies a single style. Use the \&quot;Accept:\&quot; header to specify format or append an extension to the endpoint (example &#x60;/styles/{style}.xml&#x60; for XML). Using PUT with the &#x60;application/xml&#x60; or &#x60;application/json&#x60; content modifies the style info in the catalog and does not alter the style content. Using PUT with any other format will modify the content of the style. You can also use PUT with a ZIP file to upload a SLD 1.0 (&#x60;application/vnd.ogc.sld+xml&#x60;) file and any associated icon files
   * Note, this is equivalent to the other <code>uploadStyle</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link UploadStyleQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param style Name of the style to retrieve. (required)
   * @param body The style body of a request. (required)
   * @param queryParams Map of query parameters as name-value pairs
   *   <p>The following elements may be specified in the query map:</p>
   *   <ul>
   *   <li>raw - When set to \&quot;true\&quot;, will forgo parsing and encoding of the uploaded style content, and instead the style will be streamed directly to the GeoServer configuration. Use this setting if the content and formatting of the style is to be preserved exactly. May result in an invalid and unusable style if the payload is malformed. Allowable values are \&quot;true\&quot; or \&quot;false\&quot; (default). Only used when uploading a style file. (optional, default to false)</li>
   *   </ul>
   */
  @RequestLine("PUT /rest/styles/{style}?raw={raw}")
  @Headers({
  ...
  void uploadStyle(@Param("style") String style, File body, @QueryMap(encoded=true) Map<String, Object> queryParams);
  ...
  void uploadStyleByWorkspace(@Param("workspace") String workspace, @Param("style") String style, File body, @Param("raw") Boolean raw);

  /**
   * Modify a single style in a given workspace
   * Modifies a single style in a given workspace. Use the \&quot;Accept:\&quot; header to specify format or append an extension to the endpoint (example &#x60;/workspaces/{workspace}/styles/{style}.xml&#x60; for XML). Using PUT with the &#x60;application/xml&#x60; or &#x60;application/json&#x60; content modifies the style info in the catalog and does not alter the style content. Using PUT with any other format will modify the content of the style. You can also use PUT with a ZIP file to upload a SLD 1.0 (&#x60;application/vnd.ogc.sld+xml&#x60;) file and any associated icon files 
   * Note, this is equivalent to the other <code>uploadStyleByWorkspace</code> method,
   * but with the query parameters collected into a single Map parameter. This
   * is convenient for services with optional query parameters, especially when
   * used with the {@link UploadStyleByWorkspaceQueryParams} class that allows for
   * building up this map in a fluent style.
   * @param workspace Name of the workspace for style definitions (required)
   * @param style Name of the style to retrieve. (required)
   * @param body The style body of a request. (required)
  ...
  void uploadStyleByWorkspace(@Param("workspace") String workspace, @Param("style") String style, File body, @QueryMap(encoded=true) Map<String, Object> queryParams);

  /**
   * A convenience class for generating query parameters for the
   * <code>uploadStyleByWorkspace</code> method in a fluent style.
   */
  public static class UploadStyleByWorkspaceQueryParams extends HashMap<String, Object> {
    public UploadStyleByWorkspaceQueryParams raw(final Boolean value) {
      put("raw", EncodingUtils.encode(value));
      return this;
    }
  }
