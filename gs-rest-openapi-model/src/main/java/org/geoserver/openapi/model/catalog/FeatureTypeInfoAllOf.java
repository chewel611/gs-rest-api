...
public class FeatureTypeInfoAllOf {
  ...
  public FeatureTypeInfoAllOf store(DataStoreInfo store) {
  ...
  **/
  ...
  public FeatureTypeInfoAllOf attributes(List<AttributeTypeInfo> attributes) {
    
    this.attributes = attributes;
    return this;
  }

  public FeatureTypeInfoAllOf addAttributesItem(AttributeTypeInfo attributesItem) {
