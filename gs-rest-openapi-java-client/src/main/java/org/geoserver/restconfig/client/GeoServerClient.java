...
import org.geoserver.restconfig.api.client.ExtendedDefaultApi;
...
public class GeoServerClient {
    ...
    private static final String DEFAULT_BASE_URL = "http://localhost:8080/geoserver";
     ...
     */
    public void reset() {
        api(ExtendedDefaultApi.class).resetGeoServer();
    }
     ...
     */
    public void reload() {
        ExtendedDefaultApi api = api(ExtendedDefaultApi.class);
        api.reloadGeoServer();
        api.reloadGeoWebCache("reload_configuration=1".getBytes());
    }
    ...
    public LayerGroupsClient layerGroups() {
        return new LayerGroupsClient(this);
    }

    public ResourcesClient resources() {
        return new ResourcesClient(this);
    }

    public CRSClient CRS() {
        return new CRSClient(this);
    }

    public GridSetsClient gridsets() {
        return new GridSetsClient(this);
    }

    public TileLayersClient tileLayers() {
        return new TileLayersClient(this);
    }
}
